...
const LayoutList = createLucideIcon("layout-list", __iconNode$5);
/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
const APPS_SCRIPT_URL = "https://script.google.com/macros/s/AKfycbzYj1ZiuGuXG6d4ZSJGYxFlXGfHfNPoTViNT6QkNMMK4PvyhAKdSk4SUQDmqTZZmxr9Rg/exec";
...
function parseTranscript(transcript) {
  ...
  const name = tokens[0].charAt(0).toUpperCase() + tokens[0].slice(1).toLowerCase();
  let memberId = "";
  let idx = 1;
  ...
  const keywords = /* @__PURE__ */ new Set(["cash", "upi", "both"]);
...
async function lookupMember(url, query) {
  try {
    ...
    if ((data == null ? void 0 : data.name) && data.memberId) return data;
    return null;
  } catch {
    return null;
  }
...
function EntryCard({ entry, index: index2 }) {
...
function CollectionPage({ entries }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    ...
    ) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { display: "flex", flexDirection: "column", gap: "8px" }, children: entries.map((entry, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(EntryCard, { entry, index: i }, entry.id)) })
  ] });
}
function App() {
  ...
  const [nameLookup, setNameLookup] = reactExports.useState("idle");
  const [idLookup, setIdLookup] = reactExports.useState("idle");
  const nameDebounceRef = reactExports.useRef(null);
  const idDebounceRef = reactExports.useRef(null);
  ...
  const saveEntry = reactExports.useCallback((entry) => {
    ...
    setStatus("saved");
    setTimeout(() => setStatus("ready"), 2e3);
  }, []);
  const handleNameChange = reactExports.useCallback((value) => {
    setManualName(value);
    setNameLookup("idle");
  ...
  const handleMemberIdChange = reactExports.useCallback((value) => {
    ...
    if (state === "found")
      return /* @__PURE__ */ jsxRuntimeExports.jsx(
        "span",
        {
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsx(UserCheck, { size: 12, color: COLOR_CASH })
        }
      );
    if (state === "notfound")
      return /* @__PURE__ */ jsxRuntimeExports.jsx(
              ...
              activePage === "home" ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "section",
                  {
                    ...
                    children: !voiceSupported ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { color: "#f87171", fontSize: "13px", margin: 0 }, children: "Voice not supported on this browser" }) : /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "button",
                        {
                          type: "button",
                          ...
                          style: {
                            ...
                            border: isListening ? `2px solid ${COLOR_CASH}` : "2px solid #333",
                            cursor: "pointer",
                            display: "inline-flex",
                            alignItems: "center",
                            justifyContent: "center",
                          ...
                          children: isListening ? /* @__PURE__ */ jsxRuntimeExports.jsx(MicOff, { size: 28, color: COLOR_CASH }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Mic, { size: 28, color: "#888" })
                        }
                      ),
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "div",
                        {
                          ...
                          children: transcript || "Tap mic and speak..."
                        }
                      ),
                      /* @__PURE__ */ jsxRuntimeExports.jsxs(
                        "div",
                        {
                          ...
                          children: [
                            currentStatus.dot && /* @__PURE__ */ jsxRuntimeExports.jsx(
                              "span",
                              {
                                className: "dot-pulse",
                                style: {
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsxs(
                        "div",
                        {
                          ...
                          children: [
                            ...
                            hasLookupUrl && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                              "span",
                              {
                                style: {
                                  display: "flex",
                                ...
                                children: [
                                  /* @__PURE__ */ jsxRuntimeExports.jsx(UserCheck, { size: 10 }),
                                  "Sheet Lookup Active"
                                ]
                              }
                            )
                                ...
                                /* @__PURE__ */ jsxRuntimeExports.jsx(
                                  "input",
                                  {
                                    ...
                                    style: {
                                      ...
                                      borderColor: nameLookup === "found" ? `${COLOR_CASH}55` : nameLookup === "notfound" ? "#f8717144" : "#222"
                                    }
                                  }
                                ),
                                /* @__PURE__ */ jsxRuntimeExports.jsx(LookupBadge, { state: nameLookup })
                              ] })
                            ] }),
                            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                                ...
                                /* @__PURE__ */ jsxRuntimeExports.jsx(
                                  "input",
                                  {
                                    ...
                                    style: {
                                      ...
                                      borderColor: idLookup === "found" ? `${COLOR_CASH}55` : idLookup === "notfound" ? "#f8717144" : "#222"
                                    }
                                  }
                                ),
                                /* @__PURE__ */ jsxRuntimeExports.jsx(LookupBadge, { state: idLookup })
                              ] })
                            ] })
                          ]
                        }
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { style: { marginBottom: "16px" }, children: [
                  ...
                  entries.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                    ...
                    "div",
                    {
                      ...
                      children: entries.map((entry, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(EntryCard, { entry, index: i }, entry.id))
                    }
                  )
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                                ...
                                children: [
                                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                                    "p",
                                    {
                                      ...
                                      children: "Apps Script — Member Lookup Code"
                                    }
                                  ),
                                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                                    "pre",
    ...
    .setMimeType(ContentService.MimeType.JSON);
                                  ...
                                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                                    "p",
                                    {
                                      ...
                                      children: "Deploy as Web App → Execute as: Me → Who has access: Anyone. Sheet columns: A=MemberID, B=Name."
                                    }
                                  )
                                ]
                              }
              ...
              ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx(CollectionPage, { entries }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "footer",
                {
                  style: {
